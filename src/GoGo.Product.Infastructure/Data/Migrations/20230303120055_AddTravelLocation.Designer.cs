...
namespace GoGo.Product.Infastructure.Data.Migrations
{
    ...
    [Migration("20230303120055_AddTravelLocation")]
    partial class AddTravelLocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoGo.Product.Domain.Entities.TravelCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GoGo.Product.Domain.Entities.TravelLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TravelRegionId");

                    b.ToTable("TravelLocations");
                });

            modelBuilder.Entity("GoGo.Product.Domain.Entities.TravelRegion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TravelCategoryId");

                    b.ToTable("TravelRegions");
                });
            ...
            modelBuilder.Entity("GoGo.Product.Domain.Entities.TravelLocation", b =>
                {
                    b.HasOne("GoGo.Product.Domain.Entities.TravelRegion", "TravelRegion")
                        .WithMany("TravelLocations")
                        .HasForeignKey("TravelRegionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TravelRegion");
                });

            modelBuilder.Entity("GoGo.Product.Domain.Entities.TravelRegion", b =>
                {
                    b.HasOne("GoGo.Product.Domain.Entities.TravelCategory", "TravelCategory")
                        .WithMany("TravelRegions")
                        .HasForeignKey("TravelCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TravelCategory");
                });
